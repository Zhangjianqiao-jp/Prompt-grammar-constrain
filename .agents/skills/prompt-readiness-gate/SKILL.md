...
description: Deterministically gate the first structured machine-learning research/coding prompt. Use before planning/execution or on explicit revalidation; do not use for ordinary follow-ups or non-ML domains.
---
